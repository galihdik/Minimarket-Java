...
import com.lawencon.minimarket.service.ItemServiceImpl;
import com.lawencon.minimarket.service.TransactionService;
import com.lawencon.minimarket.service.TransactionsServiceImpl;
...
public class MenuCashier {
	...
	private TransactionService transactionService = new TransactionsServiceImpl();
	...
	void addBarang() {
		...
		try {
			Items itemDB = itemService.getItemByCode(codeItems);
